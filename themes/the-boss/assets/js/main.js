 (function($) {
	...
	"use strict";
		$(document).ready(function() {
			...
			// Slider Over Switch
			// $('.fadeFromTop').parent('.cameraContent').parent('.cameraContents').parent('.camera_target_content').parent('.camera_fakehover').parent('.slider-style-two').parent('.slider').addClass('something');
