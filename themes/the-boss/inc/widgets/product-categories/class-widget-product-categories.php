<?php 
class Widget_Product_Categories extends The_Boss_Widget{


	public function __construct(){
		parent::__construct(
            'tb_recent_products_cat',
            esc_html__('The Boss :: Products Categories', 'the-boss'),
            array('description' => esc_html('Products Categories widget to display your product category.' ) )
        );
	}
		...
		<?php echo $args['before_widget']; ?>
			...
			<?php if(!empty($instance['title'])){
				echo $args['before_title'].apply_filters('widget_title',$instance['title'] ). $args['after_title'];
								...
								<?php echo $args['before_title']; ?> Recent Products <?php echo $args['after_title']; ?>
