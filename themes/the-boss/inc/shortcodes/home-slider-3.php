...
function tb_home_slider_3($limit, $order, $orderby) {?>
<section class="slider slider-style-three">
    <?php
    ...
    <div class="dark" id="camera_wrap_4">
        <?php 
        ...
        <div data-src="<?php echo esc_url($slider_thumb ); ?>">
            <div class="text-div fadeFromTop">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="slider-text dark-center row slider-text-one">
                                <h3 class="animated slideInDown"><?php echo wp_kses_post( $slider_subtitle ); ?></h3>
                                <h2 class="animated LetterSpacing delay1"><?php echo wp_kses_post( $slider_title ); ?></h2>
                                <?php echo wp_kses_post( $slider_description ); ?>
                                <a href="<?php echo esc_url( $slider_btn_url  ); ?>" class="button animated fadeInUp delay3"><?php echo esc_html( $slider_btn_text ); ?></a>
                            </div>
                        </div>
                    </div>
                </div>                          
