<?php function the_boss_team_1($title, $subtitle, $limit, $order ,$orderby , $section_bg, $btn_text,$btn_url ,$tb_class){ ?>

		<section class="section team-section team-section-two team-member-page <?php echo (!empty( $tb_class )) ? esc_attr( $tb_class ) : ''; ?>" <?php if($section_bg) : ?>style="background:<?php echo esc_attr($section_bg ); ?>" <?php endif; ?> >
			<div class="container">
				<div class="row">
						...
						<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="single-team-member">
								<div class="member-image">
									<?php the_post_thumbnail( 'the-boss-team-2' ); ?>
