...
class WPBakeryShortCode_the_boss_testimonials_2 extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        ob_start();
        the_boss_testimonials_2( $limit, $order ,$orderby , $section_bg);
        return ob_get_clean();	         
    }
}

vc_map( array(
    "base"                  => "the_boss_testimonials_2",
    "name"                  => esc_html__("The Boss : Testimonials 2", 'the-boss'),
    "class"                 => "",
