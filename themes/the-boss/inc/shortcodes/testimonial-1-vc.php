...
class WPBakeryShortCode_the_boss_testimonials extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        ob_start();
        the_boss_testimonials($title, $subtitle, $limit, $order ,$orderby , $section_bg, $btn_text,$btn_url ,$tb_class);
        return ob_get_clean();	         
    }
}

vc_map( array(
    "base"                  => "the_boss_testimonials",
    "name"                  => esc_html__("The Boss : Testimonials", 'the-boss'),
    "class"                 => "",
    ...
    "params" => array(
        ...
        array(
            "type"          => "textfield",
            "heading"       => esc_html__("Testimonial Limit:", 'the-boss'),
            "param_name"    => "limit",
            "description"   => esc_html__("Write down the number of Member you want to display", 'the-boss'),
        ),
        array(
            "type"          => "dropdown",
            "heading"       => esc_html__( "Testimonial Order", 'the-boss' ),
            "param_name"    => "order",                
            "value"         => array(
        ...
        array(
            "type"          => "dropdown",
            "heading"       => esc_html__( "Testimonial Order By", 'the-boss' ),
            "param_name"    => "orderby",
            "value"         => array(
