...
class WPBakeryShortCode_the_boss_portfolio_3 extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        ob_start();
        the_boss_portfolio_3($title, $subtitle, $limit, $order ,$orderby , $section_bg, $btn_text,$btn_url ,$tb_class);
        return ob_get_clean();           
    }
}

vc_map( array(
    "base"                  => "the_boss_portfolio_3",
    "name"                  => esc_html__("Portfolio 3", 'the-boss'),
    "class"                 => "",
    ...
    "params" => array(
        ...
        array(
            "type"          => "textfield",
            "heading"       => esc_html__("Portfolio Limit:", 'the-boss'),
            "param_name"    => "limit",
            "description"   => esc_html__("Write down the number of slide you want to display", 'the-boss'),
        ),
        array(
            "type"          => "dropdown",
            "heading"       => esc_html__( "Portfolio Order", 'the-boss' ),
            "param_name"    => "order",                
            "value"         => array(
        ...
        array(
            "type"          => "dropdown",
            "heading"       => esc_html__( "Portfolio Order By", 'the-boss' ),
            "param_name"    => "orderby",
            "value"         => array(
        ...
        array(
            "type"       => "textfield",
            "heading"    => esc_html__("Portfolio Button Text", 'the-boss'),
            "description"=> esc_html__("Please keep empty if you want to hide this button.", 'the-boss'),
            "param_name" => "btn_text",
        ),
        array(
            "type"       => "textfield",
            "heading"    => esc_html__("Portfolio Button Url", 'the-boss'),
            "param_name" => "btn_url",
        ),
        array(
            "type"       => "colorpicker",
