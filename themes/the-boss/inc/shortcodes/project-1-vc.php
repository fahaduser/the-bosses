...
class WPBakeryShortCode_the_boss_project_1 extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        ob_start();
        the_boss_project_1($title, $subtitle, $limit, $order ,$orderby , $section_bg, $btn_text,$btn_url ,$tb_class);
        return ob_get_clean();	         
    }
}

vc_map( array(
    "base"                  => "the_boss_project_1",
    "name"                  => esc_html__("Recent Project 1", 'the-boss'),
    "class"                 => "",
    ...
    "params" => array(
        ...
        array(
            "type"          => "textfield",
            "heading"       => esc_html__("Project Limit:", 'the-boss'),
            "param_name"    => "limit",
            "description"   => esc_html__("Write down the number of slide you want to display", 'the-boss'),
        ),
        array(
            "type"          => "dropdown",
            "heading"       => esc_html__( "Project Order", 'the-boss' ),
            "param_name"    => "order",                
            "value"         => array(
        ...
        array(
            "type"          => "dropdown",
            "heading"       => esc_html__( "Project Order By", 'the-boss' ),
            "param_name"    => "orderby",
            "value"         => array(
        ...
        array(
            "type"       => "textfield",
            "heading"    => esc_html__("Project Button Text", 'the-boss'),
            "description"=> esc_html__("Please keep empty if you want to hide this button.", 'the-boss'),
            "param_name" => "btn_text",
        ),
        array(
            "type"       => "textfield",
            "heading"    => esc_html__("Project Button Url", 'the-boss'),
            "param_name" => "btn_url",
        ),
        array(
            "type"       => "colorpicker",
