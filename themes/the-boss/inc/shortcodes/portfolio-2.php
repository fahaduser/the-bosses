...
function the_boss_portfolio_2( $title, $subtitle, $limit, $order ,$orderby , $section_bg, $btn_text,$btn_url ,$tb_class ){ ?>
	<div class="section portfolio-page-two <?php echo (!empty( $tb_class )) ? esc_attr( $tb_class ) : ''; ?>" <?php if($section_bg) : ?>style="background:<?php echo esc_attr($section_bg ); ?>" <?php endif; ?>>
		<div class="container">
			<div class="row">
						...
						<div class="row">
							<div class="single-portfolio">
								<div class="single-portfolio-inner">
									<?php the_post_thumbnail('the-boss-portfolio-2-in' ); ?>
