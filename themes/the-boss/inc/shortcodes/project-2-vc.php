...
class WPBakeryShortCode_the_boss_project_2 extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
        ...
        ob_start();
        the_boss_project_2($title, $subtitle, $limit, $order ,$orderby , $section_bg, $btn_text,$btn_url ,$tb_class);
        return ob_get_clean();	         
    }
}

vc_map( array(
    "base"                  => "the_boss_project_2",
    "name"                  => esc_html__("Recent Project 2", 'the-boss'),
    "class"                 => "",
