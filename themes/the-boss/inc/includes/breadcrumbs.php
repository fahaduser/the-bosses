 ...
 */
function the_boss_breadcrumbs($class = '') {

    // Settings
    $separator	 = '&gt;';
    $breadcrums_id	 = 'breadcrumbs';
    $breadcrums_class	 = 'breadcrumb-ul ' . $class;
    $home_title	 = esc_html__('Home', 'the-boss');
    ...
    if ( !is_front_page() ) {
        ...
        if ( is_author() ) {
            ...
            echo '<li class="active-breadcrumb"><span class="bread-current bread-archive">' . $custom_tax_name . '</span></li>';
        } else if (class_exists( 'the-boss' ) && is_product()) {
                echo '<li class="active-breadcrumb"><span class="bread-current bread-archive">' . get_the_title('') . '</span></li>'; 
        } else if (class_exists( 'the-boss' ) && is_woocommerce()) {
            echo '<li class="active-breadcrumb"><span class="bread-current bread-archive">' . woocommerce_page_title('') . '</span></li>'; 
        } else if (class_exists( 'bbPress' ) && is_bbpress()) {
            echo '<li class="active-breadcrumb"><span class="bread-current bread-archive">' . get_the_title() . '</span></li>';
            
        } else if ( is_archive() && !is_tax() && !is_category() && !is_tag() ) {

            echo '<li class="active-breadcrumb"><span class="bread-current bread-archive">' . get_the_archive_title() . '</span></li>';
            ...
            // Paginated archives
            echo '<li class="item-current item-current-' . get_query_var('paged') . '"><span class="bread-current bread-current-' . get_query_var('paged') . '" title="Page ' . get_query_var('paged') . '">'.esc_html__('Page','the-boss') . ' ' . get_query_var('paged') . '</span></li>';
